...
class Lens(models.Model):
    ...
    tAB = models.CharField(max_length=20, null=True, blank=True)
    ErrtAB = models.FloatField(null=True, blank=True)
    tAC = models.FloatField(null=True, blank=True)
    ErrtAC = models.FloatField(null=True, blank=True)
    tBC = models.FloatField(null=True, blank=True)
    ErrtBC = models.FloatField(null=True, blank=True)
    tAD = models.FloatField(null=True, blank=True)
    ErrtAD = models.FloatField(null=True, blank=True)
    tBD = models.FloatField(null=True, blank=True)
    ErrtBD = models.FloatField(null=True, blank=True)
    tCD = models.FloatField(null=True, blank=True)
    ErrtCD = models.FloatField(null=True, blank=True)
